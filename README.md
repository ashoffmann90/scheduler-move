...
1. Create appointments with a date, time, location, and description.
   1. Location should be a dropdown/select with the following options: San Diego, Portland, Seattle, London, and Orlando.
...
6. Generate a Github page where this scheduler can be used, and submit the Github page link along with the link to the Github repo.
...
1. Appointment Information
   1. ID - React useId Hook + tiemstamp
   2. Date - string
   3. Time - string
   4. Location - string
